...
import { fetchUpdateJob } from "./actions/jobServerAction";
import { DownOutlined } from "@ant-design/icons";
import { toast } from "react-toastify";

const UpdateJobModel = (props: any) => {
  ...
  const handleOk = async () => {
    try {
      ...
      // Update user
      await fetchUpdateJob(userData, props.id);
    ...
    <div>
      ...
      >
        <Form name="validateOnly" layout="vertical" autoComplete="off">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Form.Item name="company" label="Job" rules={[{ required: true }]}>
